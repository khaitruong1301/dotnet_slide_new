...
public class ProductStoreService
{
    ...
    public async Task<HttpResponse<string>> CreateProduct(ProductStore newProduct)
    {
        // Gửi yêu cầu POST với dữ liệu dưới dạng JSON
        var response = await _httpStore.PostAsJsonAsync("/api/product/addnew", newProduct);
